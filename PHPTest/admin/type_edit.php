...
$id=$_GET['id'];
$result=mysqli_query($mysql,"select * from type where id='$id'");
...
<body>
<form action="type_editsava.php?id=<?php echo $id;?>" method="post" name="type" id="type" onsubmit="return test();">
    ...
    <div style="width: 320px;height: 30px;margin-top: 2px;display: flex;justify-content: flex-start">
        ...
        <div style="width: 0; height: 100%;margin-left: 10px;flex-grow: 1">
            <input style="width: 100%;height:25px;" type="text"
                   name="typename" id="typename"  value='<?php echo $typename?>'/>
        </div>
